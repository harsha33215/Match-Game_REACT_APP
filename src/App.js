...
class App extends Component {
  state = {
    ...
    score: 0,
    activeTab: 'FRUIT',
    targetImage: imagesList[0].imageUrl,
    isGameOver: false,
  }
  ...
  render() {
    const {timer, score, activeTab, targetImage, isGameOver} = this.state
        ...
        {isGameOver ? (
          <div className="score-card">
            ...
            <img
              ...
              className="trophy-image"
            />
            <p className="score-display">YOUR SCORE</p>
            <p className="score-display">{score}</p>
            <button onClick={this.resetGame} className="play-again-button">
              PLAY AGAIN
            </button>
          </div>
        ) : (
          <>
            <ul className="target-image-container">
              <img src={targetImage} alt="match" className="target-image" />
            </ul>
